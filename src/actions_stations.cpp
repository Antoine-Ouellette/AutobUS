...
void suivreLigne() {
    ...
    float VITESSE_CORRECTION_FAIBLE =
        VITESSE_AVANCE * 0.55; // Vitesse de correction pour retrouver la ligne
    float VITESSE_CORRECTION_ELEVEE =
        VITESSE_AVANCE * 0.55; // Vitesse de correction pour retrouver la ligne
    int depassement;
    int alignement;
